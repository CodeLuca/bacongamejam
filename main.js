...
var Fight = {
    ...
    moveCriminal: function() {
        ...
        if(criminalFight.y < playerFight.y && criminalFight.y < 5 + playerFight.y){criminalFight.y += 0.6 +(level/10);} else if (criminalFight.y > playerFight.y && criminalFight.y > 5+ playerFight.y){criminalFight.y += -0.6 + + (level/10)}
        if(criminalFight.x < playerFight.x && criminalFight.x < 5 + playerFight.x){criminalFight.x += 0.6 +(level/10);} else if (criminalFight.x > playerFight.x && criminalFight.x > 5+ playerFight.x){criminalFight.x += -0.6 + + (level/10)}
    },
